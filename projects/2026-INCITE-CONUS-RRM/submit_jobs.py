...
grid_name_list.append('2026-incite-conus-1024x2') # num_elem=7908298  1.25* ne1024 (6291456)
...
for grid_name in grid_name_list:
  ...
  if host=='NERSC':
    ...
    topo_slurm_opts = None
    if grid_name=='2026-incite-conus-1024x2': topo_slurm_opts = '--nodes=8 --cpus-per-task=8 --time=4:00:00'
    if grid_name=='2026-incite-conus-1024x3': topo_slurm_opts = '--nodes=32 --cpus-per-task=8 --time=4:00:00'
    if grid_name=='2026-incite-conus-1024x4': topo_slurm_opts = '--nodes=64 --cpus-per-task=8 --time=4:00:00'
    if topo_slurm_opts is None: topo_slurm_opts = '--nodes=4 --cpus-per-task=32 --time=0:30:00'
