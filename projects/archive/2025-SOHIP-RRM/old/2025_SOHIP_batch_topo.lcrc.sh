...
#SBATCH --output=/home/ac.whannah/E3SM_grid_support/2025-SOHIP-RRM/logs_slurm/SOHIP_slurm_%x_%j.out
#SBATCH --time=12:00:00
#SBATCH --nodes=1
#SBATCH --mail-user=hannah6@llnl.gov
#SBATCH --mail-type=END,FAIL
#-------------------------------------------------------------------------------
# grid_name=2025-sohip-256x3-ptgnia-v1;sbatch --job-name=SOHIP_gen_topo_$grid_name --export=ALL,grid_name=$grid_name ${HOME}/E3SM_grid_support/2025-SOHIP-RRM/2025_SOHIP_batch_topo.lcrc.sh
# grid_name=2025-sohip-256x3-sw-ind-v1;sbatch --job-name=SOHIP_gen_topo_$grid_name --export=ALL,grid_name=$grid_name ${HOME}/E3SM_grid_support/2025-SOHIP-RRM/2025_SOHIP_batch_topo.lcrc.sh
# grid_name=2025-sohip-256x3-eq-ind-v1;sbatch --job-name=SOHIP_gen_topo_$grid_name --export=ALL,grid_name=$grid_name ${HOME}/E3SM_grid_support/2025-SOHIP-RRM/2025_SOHIP_batch_topo.lcrc.sh
# grid_name=2025-sohip-256x3-se-pac-v1;sbatch --job-name=SOHIP_gen_topo_$grid_name --export=ALL,grid_name=$grid_name ${HOME}/E3SM_grid_support/2025-SOHIP-RRM/2025_SOHIP_batch_topo.lcrc.sh
# grid_name=2025-sohip-256x3-sc-pac-v1;sbatch --job-name=SOHIP_gen_topo_$grid_name --export=ALL,grid_name=$grid_name ${HOME}/E3SM_grid_support/2025-SOHIP-RRM/2025_SOHIP_batch_topo.lcrc.sh
# grid_name=2025-sohip-256x3-sc-ind-v1;sbatch --job-name=SOHIP_gen_topo_$grid_name --export=ALL,grid_name=$grid_name ${HOME}/E3SM_grid_support/2025-SOHIP-RRM/2025_SOHIP_batch_topo.lcrc.sh
#-------------------------------------------------------------------------------
# LCRC paths
...
echo "   np4 scrip grid file = ${grid_root}/${grid_name}-np4_scrip.nc"; echo
