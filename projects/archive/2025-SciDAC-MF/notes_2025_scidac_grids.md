...
# special checks for topo consistency
...
grid_gll_ne18=${data_root}/files_grid/exodus_ne18.g
grid_gll_ne22=${data_root}/files_grid/exodus_ne22.g
grid_gll_ne26=${data_root}/files_grid/exodus_ne26.g
grid_pg2_ne30=${data_root}/files_grid/ne30pg2_scrip.nc

map_ne18_to_ne30=${data_root}/files_map/map_ne18np4_to_ne30pg2_se2fv_flx.nc
map_ne22_to_ne30=${data_root}/files_map/map_ne22np4_to_ne30pg2_se2fv_flx.nc
map_ne26_to_ne30=${data_root}/files_map/map_ne26np4_to_ne30pg2_se2fv_flx.nc

ncremap -a se2fv_flx --src_grd=${grid_gll_ne18} --dst_grd=${grid_pg2_ne30} --map_file=${map_ne18_to_ne30}
ncremap -a se2fv_flx --src_grd=${grid_gll_ne22} --dst_grd=${grid_pg2_ne30} --map_file=${map_ne22_to_ne30}
ncremap -a se2fv_flx --src_grd=${grid_gll_ne26} --dst_grd=${grid_pg2_ne30} --map_file=${map_ne26_to_ne30}

init_ne18_orig=${din_loc_root}/atm/cam/inic/homme/HICCUP.eam_i_mam3_Linoz_ne18np4_L80_c20250530.nc
init_ne22_orig=${din_loc_root}/atm/cam/inic/homme/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250530.nc

init_ne18_remap=${data_root}/files_test/HICCUP.eam_i_mam3_Linoz_ne18np4_L80_c20250530.remap_ne30pg2.nc
init_ne22_remap=${data_root}/files_test/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250530.remap_ne30pg2.nc

ncremap -v PS,T -m ${map_ne18_to_ne30} -i ${init_ne18_orig} -o ${init_ne18_remap}
ncremap -v PS,T -m ${map_ne22_to_ne30} -i ${init_ne22_orig} -o ${init_ne22_remap}
ncdiff ${init_ne18_remap} ${init_ne22_remap} ${data_root}/files_diff/diff_init_ne18_ne22.nc



topo_ne18_orig=${din_loc_root}/atm/cam/topo/USGS-topo_ne18np4_smoothedx6t_20250513.nc
topo_ne22_orig=${din_loc_root}/atm/cam/topo/USGS-topo_ne22np4_smoothedx6t_20250513.nc

topo_ne18_remap=${data_root}/files_test/USGS-topo_ne18np4_smoothedx6t_20250513.remap_ne30pg2.nc
topo_ne22_remap=${data_root}/files_test/USGS-topo_ne22np4_smoothedx6t_20250513.remap_ne30pg2.nc

ncremap -v PHIS_d -m ${map_ne18_to_ne30} -i ${topo_ne18_orig} -o ${topo_ne18_remap}
ncremap -v PHIS_d -m ${map_ne22_to_ne30} -i ${topo_ne22_orig} -o ${topo_ne22_remap}
ncdiff ${topo_ne18_remap} ${topo_ne22_remap} ${data_root}/files_diff/diff_topo_ne18_ne22.nc


init_ne18_old=${din_loc_root}/atm/cam/inic/homme/HICCUP.eam_i_mam3_Linoz_ne18np4_L80_c20250530.nc
init_ne18_new=${data_root}/files_init/HICCUP.eam_i_mam3_Linoz_ne18np4_L80_c20250612.nc

ncdiff -v PS ${init_ne18_new} ${init_ne18_old} ${data_root}/files_diff/diff_init_ne18_ne18.nc


init_ne22_old=${din_loc_root}/atm/cam/inic/homme/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250530.nc
init_ne22_new=${data_root}/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250612.nc

ncdiff -v PS ${init_ne22_new} ${init_ne22_old} ${data_root}/files_diff/diff_init_ne22_ne22.nc


init_ne22_a=${data_root}/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250612a.nc
init_ne22_b=${data_root}/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250612b.nc
echo ncdiff -v PS ${init_ne22_a} ${init_ne22_b} ${data_root}/files_diff/diff_init_ne22a_ne22b.nc

data_root=/global/cfs/cdirs/m4310/whannah
init_ne22_a=/global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250612.nc
init_ne22_b=/global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_w-topo-x6t_c20250616.nc
ncdiff -v PS,T ${init_ne22_b} ${init_ne22_a} ${data_root}/files_diff/diff_init_ne22a_ne22b.nc


init_ne22_a=/global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_w-topo-16xdel2_c20250616.nc
init_ne22_b=/global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_w-topo-x6t_c20250616.nc
ncdiff -v PS,T ${init_ne22_b} ${init_ne22_a} /global/cfs/cdirs/m4310/whannah/files_diff/diff_init_ne22b_ne22c.nc

init_ne22_a=/global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_w-topo-16xdel2_c20250616.nc
init_ne22_b=/global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_w-topo-16xdel2_c20250616_alt.nc
ncdiff -v PS,T ${init_ne22_b} ${init_ne22_a} /global/cfs/cdirs/m4310/whannah/files_diff/diff_init_ne22b_ne22c.nc
```
...
ne_dst=22
map_file=/global/cfs/cdirs/m4310/whannah/files_map/map_ne30np4_to_ne${ne_dst}np4.nc
src_file=/global/cfs/cdirs/e3sm/inputdata/atm/cam/inic/homme/eami_mam4_Linoz_ne30np4_L80_c20231010.nc
dst_file=/global/cfs/cdirs/m4310/whannah/files_init/eami_mam4_Linoz_ne${ne_dst}np4_L80_c20250616_simple-remap.nc
ncremap -m ${map_file} -i ${src_file} -o ${dst_file}
echo ; echo ${dst_file} ; echo 

cp /global/cfs/cdirs/m4310/whannah/files_init/eami_mam4_Linoz_ne22np4_L80_c20250616_simple-remap.nc /global/cfs/cdirs/e3sm/inputdata/atm/cam/inic/homme/
...
# ds = xr.open_dataset('/global/cfs/cdirs/m4310/whannah/files_hiccup_tmp/tmp_data.ne22np4.L80.T.20250612a.nc')
# print(ds)

# print('PS' in ds)
# print('PS' in ds.data_vars)
# print('PS' in ds.variables)

ds_tmp_a = xr.open_dataset('/global/cfs/cdirs/m4310/whannah/files_hiccup_tmp/tmp_data.ne22np4.L80.PS.20250612a.nc')
ds_tmp_b = xr.open_dataset('/global/cfs/cdirs/m4310/whannah/files_hiccup_tmp/tmp_data.ne22np4.L80.PS.20250612b.nc')

ds_int_a = xr.open_dataset('/global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250612a.nc')
ds_int_b = xr.open_dataset('/global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250612b.nc')

tmp_diff = ds_tmp_a['PS'] - ds_tmp_b['PS']
int_diff = ds_int_a['PS'] - ds_int_b['PS']
print(f'''
  temp PS a    : {ds_tmp_a['PS'].mean().values}
  temp PS b    : {ds_tmp_b['PS'].mean().values}
  temp PS diff : {tmp_diff      .mean().values}

  init PS a    : {ds_int_a['PS'].mean().values}
  init PS b    : {ds_int_b['PS'].mean().values}
  init PS diff : {int_diff      .mean().values}
''')
...
```shell
ncdump -h /global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250612a.nc > header_20250612a.txt
ncdump -h /global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_c20250612b.nc > header_20250612b.txt
diff header_20250612a.txt header_20250612b.txt
```
...
## cime_config/config_grids.xml - bi-grid
...
##  cime_config/config_grids.xml - tri-grid

### tri-grid - grid defintion
...
```xml
    ...
    <gridmap atm_grid="ne22np4.pg2" ocn_grid="IcoswISC30E3r5">
      ...
      <map name="ATM2OCN_SMAPNAME">cpl/gridmaps/ne22pg2/map_ne22pg2_to_IcoswISC30E3r5_trbilin.20240205.nc</map>
    ...
    <gridmap atm_grid="ne26np4.pg2" ocn_grid="IcoswISC30E3r5">
      ...
      <map name="ATM2OCN_SMAPNAME">cpl/gridmaps/ne26pg2/map_ne26pg2_to_IcoswISC30E3r5_trbilin.20240205.nc</map>
    ...
    <gridmap atm_grid="ne30np4.pg2" ocn_grid="IcoswISC30E3r5">
      ...
      <map name="ATM2OCN_SMAPNAME">cpl/gridmaps/ne30pg2/map_ne30pg2_to_IcoswISC30E3r5_trbilin.20231121.nc</map>
...
<se_tstep            dyn_target="theta-l" hgrid="ne18np4"> 300 </se_tstep>
<se_tstep            dyn_target="theta-l" hgrid="ne22np4"> 300 </se_tstep>
<se_tstep            dyn_target="theta-l" hgrid="ne26np4"> 300 </se_tstep>

<dt_remap_factor     dyn_target="theta-l" hgrid="ne18np4"> 2 </dt_remap_factor>
<dt_remap_factor     dyn_target="theta-l" hgrid="ne22np4"> 2 </dt_remap_factor>
<dt_remap_factor     dyn_target="theta-l" hgrid="ne26np4"> 2 </dt_remap_factor>
...
<nu_top dyn_target="theta-l" hgrid="ne18np4"> 2.5e5 </nu_top>
<nu_top dyn_target="theta-l" hgrid="ne22np4"> 2.5e5 </nu_top>
<nu_top dyn_target="theta-l" hgrid="ne26np4"> 2.5e5 </nu_top>
...
cp /global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne18np4_L80_w-topo-16xdel2_c20250620.nc /global/cfs/cdirs/e3sm/inputdata/atm/cam/inic/homme/
cp /global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne22np4_L80_w-topo-16xdel2_c20250620.nc /global/cfs/cdirs/e3sm/inputdata/atm/cam/inic/homme/
cp /global/cfs/cdirs/m4310/whannah/files_init/HICCUP.eam_i_mam3_Linoz_ne26np4_L80_w-topo-16xdel2_c20250620.nc /global/cfs/cdirs/e3sm/inputdata/atm/cam/inic/homme/
