...
# dx_min,dx_max = 2.0,45.0; use_log_color = True # good for ne128 RRM
dx_min,dx_max = 0.2, 6.0; use_log_color = True # good for ne1024 RRM
#---------------------------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------------------------
def set_subtitles(wks, plot, lstr='', cstr='', rstr='', font_height=0.01):
  ttres         = ngl.Resources()
  ttres.nglDraw = False
...
for f in range(num_grid):
  ...
  if use_log_color:
    # log scaling works best for RRM
